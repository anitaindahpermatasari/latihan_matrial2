                ...
                <div class="misc-wrapper">
                    <a class="brand-logo" href="javascript:void(0);">
                        <div class="row mx-4 mt-4">
                            <img class="" src="{{ asset('/images/logo/logolaravel.png') }}" height="40" width="40">
                            <h2 class="brand-text text-primary ml-1 mt-50 font-weight-bolder">WEBSITE LARAVEL</h2>
                        </div>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">
                                Untuk mengaktifkan akun kamu silahkan hubungi WEBSITE LARAVEL.
                            </p>

...
<head>
    ...
    <meta name="description" content="WEBSITE LARAVEL">
    <meta name="keywords" content="UD, bangunan, cirebon">
    <meta name="author" content="Sunset Orange">
    <title>{{ $title }}</title>
    <link rel="apple-touch-icon" href="{{ asset('/images/logo/logolaravel.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/images/logo/logolaravel.png') }}">
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click"
    ...
    @if (session('status'))
        <div class="toast toast-basic position-fixed fade show" id="toast" role="status" aria-live="polite"
            ...
            <div class="toast-header">
                <img src="{{ asset('/images/logo/logolaravel.png') }}" class="mr-1" alt="Toast image" height="25"
                    width="25">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="">
                        <img src="{{ asset('/images/logo/logolaravel.png') }}" height="40" width="40">
                        <h3 class="brand-text">LARAVEL</h3>
                    </a></li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy;
                {{ date('Y') }}<a class="ml-25">Website Laravel</a><span class="d-none d-sm-inline-block">, Pemrograman Internet Lanjutan</span></span><span class="float-md-right d-none d-md-block">Anita Indah Permata Sari<i
